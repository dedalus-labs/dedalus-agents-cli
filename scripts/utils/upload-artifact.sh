...
if echo "$UPLOAD_RESPONSE" | grep -q "HTTP/[0-9.]* 200"; then
  ...
  echo -e "\033[32mInstallation: Download and unzip: 'https://pkg.stainless.com/s/dedalus-sdk-cli/$SHA'. On macOS, run 'xattr -d com.apple.quarantine {executable name}'.\033[0m"
else
